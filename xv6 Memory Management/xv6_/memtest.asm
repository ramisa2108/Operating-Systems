  ...
  13:	83 39 01             	cmpl   $0x1,(%ecx)
{
  16:	8b 41 04             	mov    0x4(%ecx),%eax
    if(argc < 2)
  19:	0f 8e bd 00 00 00    	jle    dc <main+0xdc>
    {
  ...
  25:	e8 c6 02 00 00       	call   2f0 <atoi>

    if(sw)
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	0f 85 ba 00 00 00    	jne    ef <main+0xef>
  ...
  38:	68 00 40 01 00       	push   $0x14000
  3d:	e8 de 06 00 00       	call   720 <malloc>
  ...
  43:	89 c3                	mov    %eax,%ebx
    printf(1, "Press ^P\n");
  45:	58                   	pop    %eax
  46:	68 52 08 00 00       	push   $0x852
  4b:	6a 01                	push   $0x1
  4d:	e8 6e 04 00 00       	call   4c0 <printf>
    
    fork();
  52:	e8 04 03 00 00       	call   35b <fork>

    sleep(200);
  57:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
  5e:	e8 90 03 00 00       	call   3f3 <sleep>
  ...
  6f:	90                   	nop
    {
        a[i]=i;
  70:	89 04 83             	mov    %eax,(%ebx,%eax,4)
    for(int i=0;i<n;i++)
  73:	83 c0 01             	add    $0x1,%eax
  76:	3d 00 50 00 00       	cmp    $0x5000,%eax
  7b:	75 f3                	jne    70 <main+0x70>
    }
    
    sbrk(5*4096);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	68 00 50 00 00       	push   $0x5000
  85:	e8 61 03 00 00       	call   3eb <sbrk>
  ...
  91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    {
        if(a[i] != i)
  98:	39 04 83             	cmp    %eax,(%ebx,%eax,4)
  9b:	74 03                	je     a0 <main+0xa0>
        {
            cnt++;
  9d:	83 c2 01             	add    $0x1,%edx
    for(int i=0;i<n;i++)
  a0:	83 c0 01             	add    $0x1,%eax
  a3:	3d 00 50 00 00       	cmp    $0x5000,%eax
  a8:	75 ee                	jne    98 <main+0x98>
    ...
    if(cnt == 0)
  aa:	85 d2                	test   %edx,%edx
  ac:	74 1b                	je     c9 <main+0xc9>
    {
  ...
  bc:	83 c4 10             	add    $0x10,%esp
    ...
    wait();
  bf:	e8 a7 02 00 00       	call   36b <wait>
    
    exit();
  c4:	e8 9a 02 00 00       	call   363 <exit>
        printf(1, "all numbers match\n");
  c9:	52                   	push   %edx
  ca:	52                   	push   %edx
  cb:	68 5c 08 00 00       	push   $0x85c
  d0:	6a 01                	push   $0x1
  d2:	e8 e9 03 00 00       	call   4c0 <printf>
  d7:	83 c4 10             	add    $0x10,%esp
  da:	eb e3                	jmp    bf <main+0xbf>
        printf(1,"Enter swapping algorithm:\n0:FIFO\n1:Aging\n");
  dc:	50                   	push   %eax
  dd:	50                   	push   %eax
  de:	68 28 08 00 00       	push   $0x828
  e3:	6a 01                	push   $0x1
  e5:	e8 d6 03 00 00       	call   4c0 <printf>
        exit();
  ea:	e8 74 02 00 00       	call   363 <exit>
        aging();
  ef:	e8 0f 03 00 00       	call   403 <aging>
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 86 08 00 00       	mov    $0x886,%ebx
        while(*s != 0){
